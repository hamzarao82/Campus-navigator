    ...
    <View className="flex-1 bg-white p-6">
      ...
      <View className="space-y-4">
        <TouchableOpacity className="bg-blue-100 p-4 rounded-lg">
          <Text className="text-blue-800 font-semibold">User Permissions</Text>
        </TouchableOpacity>
        <TouchableOpacity className="bg-blue-100 p-4 rounded-lg">
          <Text className="text-blue-800 font-semibold">PIN Management</Text>
        </TouchableOpacity>
        <TouchableOpacity className="bg-blue-100 p-4 rounded-lg">
          <Text className="text-blue-800 font-semibold">Course Schedule</Text>
        </TouchableOpacity>
        <TouchableOpacity className="bg-blue-100 p-4 rounded-lg">
          <Text className="text-blue-800 font-semibold">System Updates</Text>
        </TouchableOpacity>
        <TouchableOpacity 
